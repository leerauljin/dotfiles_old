...
(map! :map org-mode-map
      :leader
      :desc "Insert node"
      "m 1" #'org-roam-node-insert-immediate
      :desc "Insert node immediately"
      "m !" #'org-roam-node-insert-immediate
      :desc "Insert Citation"
      "m 2" #'org-ref-insert-cite-link
...
(setq org-roam-capture-templates
      '(("d" "default" plain "%?"
        ...
        ("n" "Annotation" plain "%?"
         ...
         :unnarrowed t)
        ("N" "Annotation, without prompt" plain "%?"
         :target (file+head "annotations/%<%y%m%d-%H%M>-${citekey}.org"
                            "#+title: ${author-or-editor-abbrev} (${date})  ${title}\n* Notes\n:PROPERTIES:\n:NOTER_DOCUMENT: ${file}\n:END:\n** _Keywords_\n\n** Model\n\n** Variable\n\n** Theory\n\n** Method\n\n** Subject\n\n** Findings\n\n")
         :immediate-finish t)
        ))
