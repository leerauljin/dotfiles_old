...
(defun auto-org-babel-tangle ()
  (when (string-equal (buffer-file-name)
                      (expand-file-name "~/Documents/Dev/dotfiles/doom-emacs/config.org"))
...
** Ivy-bibtex
#+begin_src emacs-lisp :tangle yes
(setq bibtex-completion-bibliography "~/Documents/Academic/Org-papers/zotero-refs.bib"
...
(setq
 ...
 org-ref-default-bibliography "~/Documents/Academic/Org-papers/zotero-refs.bib"
...
;;       '((main . "${author editor:20}     ${date year issued:4}     ${title:48}")
;;         (suffix . "          ${=type=:12}    ${tags keywords:*}")
;;         (note . "Notes on ${author editor}, ${title}")))
#+end_src
*** Default folder
#+begin_src emacs-lisp :tangle yes
;; (setq citar-bibliography "~/Documents/Academic/Org-papers/zotero-refs.bib")
#+end_src
** Org-roam bibtex
#+begin_src emacs-lisp :tangle yes
